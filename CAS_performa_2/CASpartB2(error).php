...
<body>
        ...
        <br>
        <form action="CASpartB2.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
<input required style="width: 240px; text-align: center;" class="form-control" type="file" id="formFileMultiple" multiple>
...

  {
                        ...
                        //   $sql4="delete from sdata where title ='".null."';
                    ...
                    <?php            if($data)
                         ...
                         if($showAlert){
                           header("Location: CASpartB2.php",true);   
                         } 
                       else {
